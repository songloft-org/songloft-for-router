                                                                ...
                                                                <tr>
                                                                        <td bgcolor="#4D595D" colspan="3" valign="top">
                                                                                ...
                                                                                <div class="SimpleNote">
                                                                                        ...
                                                                                        <div>3. 若需自定义二进制路径（如外置存储），可在"二进制路径"中填写绝对路径；留空则使用默认路径 <span style="color:#00c6ff;">/jffs/softcenter/bin/songloft</span>。</div>
                                                                                </div>
                                                                                        ...
                                                                                        <tr id="tr_db_path">
                                                                                                ...
                                                                                                <td>
                                                                                                        <input id="songloft_db_path" class="input_ss_table" style="width:360px;" value=""
                                                                                                                placeholder="例如：/jffs/softcenter/songloft"
                                                                                                                autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />
                                                                                        ...
                                                                                        <tr id="tr_bin_path">
                                                                                                ...
                                                                                                <td>
                                                                                                        <input id="songloft_bin_path" class="input_ss_table" style="width:400px;" value=""
                                                                                                                placeholder="留空使用 /jffs/softcenter/bin/songloft"
                                                                                                                autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />
                                                                                                </td>
                                                                                        </tr>
                                                                                </table>
